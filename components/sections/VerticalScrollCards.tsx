    ...
    return (
        <section ref={containerRef} className="relative h-[300vh] bg-neutral-950">
            ...
            <div className="sticky top-0 h-screen w-full flex flex-col bg-white overflow-hidden">
                ...
                <div className="shrink-0 px-6 md:px-20 py-4 lg:py-6 bg-white z-10 border-b border-black/5 flex flex-col lg:flex-row gap-6 lg:gap-10 items-end">
                        ...
                        return (
                            ...
                            >
                                <div className="h-full flex flex-col relative">
                                    ...
                                    <div className={`px-6 md:px-20 py-3 md:py-5 flex items-center gap-4 md:gap-6 cursor-pointer ${isActive ? 'border-b border-black/5' : ''}`}>
                                    ...
                                    {/* Body Content */}
                                    <motion.div
                                        className="flex-1 px-6 md:px-20 py-4 md:py-8 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center overflow-hidden"
