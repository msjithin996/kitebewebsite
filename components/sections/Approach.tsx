...
export default function Approach() {
    return (
        <section className="py-24 md:py-32 px-6 md:px-20 lg:px-40 bg-white text-black" data-header-theme="dark">
            <div className="container mx-auto">
                <div className="flex flex-col gap-12 md:gap-16">
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-4 relative">
                        ...
                        {/* Arrow 1 */}
                        <div className="hidden md:flex shrink-0 items-start justify-center w-[120px] lg:w-[150px] pt-[34px] px-2">
                            <img
