...
import { Plus, Edit, Trash2, Eye, Calendar, FileText, FlaskConical } from "lucide-react";
...
export default function ResearchPage() {
    ...
    const fetchPosts = async () => {
        try {
            ...
            // Filter for research/blog
            const researchPosts = postsData.filter(p => p.postType === "research");

            // Sort client-side: Newest first
            researchPosts.sort((a, b) => {
        ...
        <div className="min-h-screen p-8">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-gray-400 mt-1">Manage your research articles and blog posts</p>
                </div>
                <Link
                    href="/admin/posts/new?type=research"
            ...
            {loading ? (
                ...
                <div className="text-center py-20 bg-white/5 rounded-xl border border-white/10">
                    ...
                    <h3 className="text-xl font-medium text-white mb-2">No research posts yet</h3>
                    <p className="text-gray-400 mb-6">Create your first research article to get started</p>
                    <Link
                        href="/admin/posts/new?type=research"
